...
using Room_booking_Hotel_Booking.App_Code;
...
namespace Room_booking_Hotel_Booking
{
    public partial class WebForm8 : System.Web.UI.Page
    {
        ...
        {
            string a = g1.ExDB("select id,first_name,Last_name,Contact,email,address,gender,Status from userlogin ORDER BY id DESC;");
            ...
            //adapter.Fill(dt);
            DataTable dt = new DataTable();
            dt = g1.retrivaldt("select id,first_name,Last_name,Contact,email,address,gender,Status from userlogin ORDER BY id DESC");
